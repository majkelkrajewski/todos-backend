package com.majkelkrajewski.todosbackend.rest;

import com.majkelkrajewski.todosbackend.entity.Todo;
import com.majkelkrajewski.todosbackend.service.TodoService;
...
public class TodoRestController {
    ...
    public String deleteTodo(@PathVariable int todoId) {
        ...
        if(tempTodo == null) {
            throw new RuntimeException("Did not find todo with id - " + tempTodo);
        }
